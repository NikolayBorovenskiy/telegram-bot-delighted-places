...
def handle_app_place(message):
    help_message = "Привет! \n\nЯ могу помогать тебе помнить и всегда вернуться в места, " \
                   "которые тебе понравились. Просто лови момент и дай знать, что запоминать.\n\n" \
...
def handle_app_place(message):
    start_message = "Ты можешь для начала использовть комманду <b>/add</b> чтобы начать.\n\n Если хочешь узнать больше обо мне, то используй команду <b>/help</b> и я напомню о себе. \n\nУдачи!"
